...
1. Accepts two arguments on the commands line assigns them to variables. The first arguments should be your first name and the second should be your last name 
...
echo "Your first name is ${first_name} and your last name is ${last name}"
```

2. Creates a new file name output.txt
...
3. Writes the current date to output.txt using the date command (Bonus points if you can make the date command print the date in the DD-MM-YYYY format; use man date to lean how this works)
...
4. Write your full name to output.txt
...
6. Print the content of the output.txt file 
